            ...
            <Slider {...settings}>
              <div className='item'>
                <div className='single-testimonial-wrap'>
                  ...
                  <div className='client-wrap'>
                    <div className='thumb'>
                      <img src='assets/img/testimonial/1.png' alt='Gubuk Pustaka Harmoni' />
                    </div>
              ...
              <div className='item'>
                <div className='single-testimonial-wrap'>
                  ...
                  <div className='client-wrap'>
                    <div className='thumb'>
                      <img src='assets/img/testimonial/2.png' alt='Gubuk Pustaka Harmoni' />
                    </div>
                    <div className='details'>
                      <h5>MONISH POUL</h5>
                      <p>Co-Founder</p>
              ...
              <div className='item'>
                <div className='single-testimonial-wrap'>
                  ...
                  <div className='client-wrap'>
                    <div className='thumb'>
                      <img src='assets/img/testimonial/3.png' alt='Gubuk Pustaka Harmoni' />
                    </div>
                    <div className='details'>
                      <h5>MICHEL CLACRK</h5>
                      <p>Co-Founder</p>
