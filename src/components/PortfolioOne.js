        ...
        <div className='container'>
          ...
          <div className='swiper-container'>
              ...
              <Slider {...settings}>
                <div className='swiper-slide'>
                  <div className='single-portfolio-wrap'>
                    <div className='thumb'>
                      <img src='assets/img/portfolio/1.png' alt='Gubuk Pustaka Harmoni' />
                    </div>
                ...
                <div className='swiper-slide'>
                  <div className='single-portfolio-wrap'>
                    <div className='thumb'>
                      <img src='assets/img/portfolio/2.png' alt='Gubuk Pustaka Harmoni' />
                    </div>
                    <div className='portfolio-details'>
                      <div className='details'>
                        <p>Logistics Transportation</p>
                ...
                <div className='swiper-slide'>
                  <div className='single-portfolio-wrap'>
                    <div className='thumb'>
                      <img src='assets/img/portfolio/3.png' alt='Gubuk Pustaka Harmoni' />
                    </div>
                    <div className='portfolio-details'>
                      <div className='details'>
                        <p>Logistics Transportation</p>
            ...
            <div className='swiper-button-prev button'>
              <img src='assets/img/icon/left-arrow.png' alt='Gubuk Pustaka Harmoni' />
            </div>
            <div className='swiper-button-next button'>
              <img src='assets/img/icon/right-arrow.png' alt='Gubuk Pustaka Harmoni' />
            </div> */}
          </div>
        </div>
      </div>
