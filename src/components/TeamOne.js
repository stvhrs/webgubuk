                ...
                <Slider {...settings}>
                  <div className='item'>
                    <div className='single-team-wrap'>
                      <div className='thumb'>
                        <img src='assets/img/team/1.png' alt='Gubuk Pustaka Harmoni' />
                      </div>
                  ...
                  <div className='item'>
                    <div className='single-team-wrap'>
                      <div className='thumb'>
                        <img src='assets/img/team/2.png' alt='Gubuk Pustaka Harmoni' />
                      </div>
                      <div className='details'>
                  ...
                  <div className='item'>
                    <div className='single-team-wrap'>
                      <div className='thumb'>
                        <img src='assets/img/team/3.png' alt='Gubuk Pustaka Harmoni' />
                      </div>
                      <div className='details'>
                        <h5>MISHEL MARSH</h5>
                        <p>Co-Founder</p>
