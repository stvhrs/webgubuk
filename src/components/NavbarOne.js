        ...
        <div className='navbar-top'>
          <Link className='main-logo' to='/'>
            <div className='logo d-none d-xl-block'>
              <img src='/assets/img/logo.png' alt='Gubuk Pustaka Harmoni' />
            </div>
          </Link>
              ...
              <div className='col-lg-10 col-md-9 text-md-start text-center'>
                <ul className='topbar-left'>
                  <li>
                    ...
                    Pilangrejo, Gemolong, Sragen Regency, Central Java 57274
                  </li>
                  {/* <li>
                    <FaRegClock />
          ...
          <div className='container nav-container'>
            <div className='responsive-mobile-menu'>
              <button
                ...
                data-target='#gubukpustakaharmoni_main_menu'
                aria-expanded='false'
            ...
            <div className='logo'>
              <Link to='/'>
                <img src='assets/img/logo-2.png' alt='Gubuk Pustaka Harmoni' />
              </Link>
            </div>
            ...
            <div
              ...
              id='gubukpustakaharmoni_main_menu'
            >
            ...
            <div className='nav-right-part nav-right-part-desktop'>
              ...
              }} className='btn btn-base b-animate-4' to='https://siplah.blibli.com/merchant-detail/SGST-1207?itemPerPage=40&page=0&merchantId=SGST-1207'>
                {/* Span untuk efek animasi jika ada */}
                <span>
                  <img className="mb-1"
                    src='/assets/siplah.webp'
                    alt='Hubungi Kami via Siplah'
                    style={{
                      height: '34px', // Sesuaikan tinggi gambar sesuai kebutuhan
                      verticalAlign: 'center', // Untuk mensejajarkan gambar dengan teks/elemen lain jika ada

                    }}
                  />
                </span>
                {/* Anda bisa tambahkan teks opsional di sini jika gambar tidak cukup jelas */}
                {/* Contoh: <span style={{ marginLeft: '5px' }}>Hubungi Kami</span> */}
              </Link>
            </div>
          </div>
        </nav>
