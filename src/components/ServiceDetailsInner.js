          ...
          <div className='row justify-content-center'>
            <div className='col-lg-8'>
              <div className='service-details-wrap'>
                <div className='thumb'>
                  <img src='assets/img/service/7.png' alt='Gubuk Pustaka Harmoni' />
                  <div className='icon'>
                    <img
                ...
                <div className='row'>
                  <div className='col-lg-6 align-self-center'>
                    <div className='thumb mb-lg-0 mb-4'>
                      <img src='assets/img/service/8.png' alt='Gubuk Pustaka Harmoni' />
                    </div>
                  </div>
                  <div className='col-lg-6 align-self-center'>
                ...
                <div className='video-thumb-wrap pt-1 pb-4'>
                  <img src='assets/img/service/9.png' alt='Gubuk Pustaka Harmoni' />
                  <span
