              ...
              <div className='col-lg-6'>
                <div className='about-thumb-wrap'>
                  ...
                  <div className='exprience-wrap'>
                    <img src='./assets/img/about/shape-3.png' alt='Gubuk Pustaka Harmoni' />
                  ...
                  <div className='section-title mb-0'>
                    ...
                    <div className='row'>
                      ...
                      <div className='col-xl-6 col-lg-12 col-md-6 align-self-center'>
                        <div className='thumb'>
                          <img src='./assets/img/about/3.png' alt='Gubuk Pustaka Harmoni' />
                        </div>
                      </div>
                    </div>
                    <div className='btn-wrap'>
                      ...
                      <div className='author-wrap'>
                        <div className='thumb'>
                          <img src='./assets/img/about/4.png' alt='Gubuk Pustaka Harmoni' />
                        </div>
                        <div className='details'>
                          <img
