          ...
          <div className='row justify-content-center'>
            <div className='col-lg-4 col-md-6'>
              <div className='single-blog-inner'>
                <div className='thumb'>
                  <img src='assets/img/blog/1.png' alt='Gubuk Pustaka Harmoni' />
                </div>
            ...
            <div className='col-lg-4 col-md-6'>
              <div className='single-blog-inner'>
                <div className='thumb'>
                  <img src='assets/img/blog/2.png' alt='Gubuk Pustaka Harmoni' />
                </div>
                <div className='details'>
                  <h4>
                    <Link to='/blog-details'>
            ...
            <div className='col-lg-4 col-md-6'>
              <div className='single-blog-inner'>
                <div className='thumb'>
                  <img src='assets/img/blog/3.png' alt='Gubuk Pustaka Harmoni' />
                </div>
                <div className='details'>
                  <h4>
                    <Link to='/blog-details'>
